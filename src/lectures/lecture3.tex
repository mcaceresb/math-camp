...
\begin{remark}
  During class, I was asked how we know that the budget correspondence was compact, uhc, and lhc. This is not at all obvious! For the curious, I offer proofs in \Cref{sub:appendix_budget_correspondence_properties}.
\end{remark}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw [->, >=latex]
      (axis cs:3.5, 7.5) to[bend left=15] (axis cs:4.75, 5)
      node[above] at (axis cs:3.5, 7.5) {Fixed Point};
    ...
    \addplot [smooth] {0.08 * (x - 4.2)^3 - 0.2 * (x - 0.2)^2 + 0.525 * (x - 0.2) + 6.5};
    \end{axis}
    ...
    \draw [-]
      ...
      (axis cs:0,  0)
      node[above] at (axis cs:10.1, 10) {$S \times S$};
    \addplot [smooth,domain=0:4.75] {0.08 * (x - 4.2)^3 - 0.15 * (x - 0.2)^2 + 0.525 * (x - 0.2) + 6.5};
    \addplot [smooth,domain=4.75:10] {0.08 * (x - 4.2)^3 - 0.2 * (x - 0.2)^2 + 0.625 * (x - 0.2) + 5.5};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    % \draw [-, line width=0.75pt]
    \draw [-, line width=0.75pt]
      (axis cs:0, 8) -- (axis cs:6, 8) -- (axis cs:6, 2);
    \draw [-, line width=0.75pt]
      (axis cs:4, 8) -- (axis cs:4, 2) -- (axis cs:10, 2);
