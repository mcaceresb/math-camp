...
\lhead{\color{light-gray} \itshape Math Camp Aug 21, 2023 -- Lecture \thesection}
...
\begin{remark}
  ...
  To finish, differentiate the constraint $h(x(\theta); \theta) = c$ with respect to $\theta$ to get
  \begin{align*}
  ...
  by the chain rule. The right-hand appears in our expression for $D_{\theta} V(\theta)$; plug in $- D_{\theta} h(x(\theta); \theta)$ and you get the envelope theorem.
\end{remark}
