...
\begin{enumerate}[1.]
  ...
  \item {\itshape
    ...
    % \solution I intended the ``correspondence'' to be made up of singleton points, and the point of this exercise was to show you can poke a hole in a continuous function and lose continuity but still get upper or lower hemicontinuity. However, last year some people interpreted this as an interval (in which case we'd need to write $f: R^{3}_{++} \toto \mathbb{R}$), and I forgot to clarify this year. Hence I do the solution both ways (i.e. if the correspondence was singleton-valued or interval-valued).
    ...
    \begin{enumerate}
      \item \textit{Is $f$ upper hemicontinuous?}
        ...
        % For the interval-valued interpretation we cannot use the sequential definition given this is an open interval. (If they were closed intervals then a very similar proof would be sufficient since they would be closed and bounded real intervals. An earlier version of this solution had such a proof, but it was pointed out to me the intervals were open in the interval interpretation.)
        %
